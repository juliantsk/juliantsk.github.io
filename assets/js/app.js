    ...
    window.tram = function(t) {
        ...
        var L = e.frame = function() {
            ...
            D = l(function(e) {
                ...
                function h() {
                    ...
                    n = n.join(","),
                        this.style !== n && (this.style = n,
                            this.el.style[$.transition.dom] = n)
                }
                ...
                e.init = function(e) {
                        ...
                        $.backface && W.hideBackface && U(this.el, $.backface.css, "hidden")
                    },
                    b("add", r),
                    b("start", o),
                    b("wait", function(t) {
            ...
            R = l(function(t) {
                ...
                t.init = function(t, e, n, i) {
                        ...
                        n[2] && (o = n[2]),
                            ...
                            W.fallback || i.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                ...
                t.init = function() {
                    ...
                    t.values = function(t) {
                        ...
                        return n.call(this, t, function(t, n, r) {
                                i[t] = n,
                                    void 0 === this.current[t] && (e = 0, ~t.indexOf("scale") && (e = 1),
            ...
            H = l(function(e) {
                ...
                e.init = function(t) {
                        ...
                        void 0 === n && (n = i.from),
                            ...
                            this.start = C(), !1 !== t.autoplay && this.play()
                    },
                    e.play = function() {
                        var t;
        ...
        var U = t.style,
            ...
            Z = {
                ...
                "max-height": [R, x],
                "line-height": [R, k],
                "scroll-top": [I, g, "scrollTop"],
                "scroll-left": [I, g, "scrollLeft"]
            },
            Q = {};
        $.transform && (Z.transform = [P],
                Q = {
                    x: [x, "translateX"],
                    y: [x, "translateY"],
                    rotate: [_],
            ...
            $.transform && $.backface && (Q.z = [x, "translateZ"],
                Q.rotateZ = [_],
                Q.scaleZ = [g],
                Q.perspective = [y]);
        var V = /ms/,
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function g(e, n) {
            ...
            r.handler = null,
                ...
                m.test(s) ? r.handler = k : s || (a ? r.handler = _ : w())
        }
                ...
                e.find(':input:not([type="submit"])').each(function(r, o) {
                    ...
                    "string" == typeof c && (c = t.trim(c)),
                        ...
                        i = i || function(t, e, n, i) {
                            var r = null;
                            "password" === e ? r = "Passwords cannot be submitted." : t.attr("required") && (i ? h.test(t.attr("type")) && (d.test(i) || (r = "Please enter a valid email address for: " + n)) : r = "Please fill out the required field: " + n);
                            return r
                        }(a, s, u, c)
                }),
                i
        ...
        function _(e) {
            ...
            if (y(e),
                ...
                l && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "http://formdata.webflow.com")),
                    t.ajax({
                        url: s,
                        type: "POST",
                        data: r,
        ...
        return r.ready = r.design = r.preview = function() {
                ! function() {
                    if (a = t("html").attr("data-wf-site"), !(o = t(f + " form")).length)
                        return;
                    o.each(g)
                }(),
                v || s || (s = !0,
                    u.on("submit", f + " form", function(e) {
                        var n = t.data(this, f);
                        n.handler && (n.evt = e,
                            n.handler(n))
                    }))
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function x(n, r) {
            ...
            s || (s = t.data(r, d, {
                ...
                E(s),
                a ? (k(s),
                    s.el.on("setting" + d, function(t) {
                        return function(n, i) {
                            i = i || {};
                            var r = c.width();
                            E(t), !0 === i.open && j(t, !0), !1 === i.open && A(t, !0),
                    ...
                    s.button.on("tap" + d, function(t) {
                        return e.debounce(function() {
                            t.open ? A(t) : j(t)
                        })
                    }(s)),
                    s.menu.on("click" + d, "a", function(e) {
                        return function(n) {
                            var r = t(this),
                                o = r.attr("href");
        ...
        s.ready = s.design = s.preview = function() {
                if (a = f && i.env("design"),
                    n = t(document.body), !(o = l.find(d)).length)
                    return;
                o.each(x),
                    b(),
                    i.resize.on(y)
        ...
        function A(t, e) {
            if (t.open) {
                t.open = !1,
                    t.button.removeClass(p);
                var n = t.config;
                if (("none" === n.animation || !u.support.transform || n.duration <= 0) && (e = !0),
                    w.outro(0, t.el[0]),
                    l.off("tap" + d, t.outside),
                    e)
                    return u(t.menu).stop(),
                        void c();
